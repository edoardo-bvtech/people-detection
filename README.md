...
Applicazione Streamlit che utilizza il modello Roboflow per rilevare persone con mobilità ridotta (sedie a rotelle, bastoni, passeggini) nei video.
...
- `inference-sdk==0.45.1` - API Roboflow
...
[Edoardo BV Tech](https://github.com/edoardo-bvtech)